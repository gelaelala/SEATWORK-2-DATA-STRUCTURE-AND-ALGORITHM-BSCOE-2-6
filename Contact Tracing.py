    ...
    while True:
        ...
        if user_input == 1:
            ...
            if f"{name_input}" in contact_tracing:
                ...
                print ("Age: ", contact_tracing[full_name]["Age"])
                print ("Sex: ", contact_tracing[full_name]["Sex"])
                print ("Birthday: ", contact_tracing[full_name]["Birthday"])
                print ("Address: ", contact_tracing[full_name]["Address"])
                print ("Phone Number: ", contact_tracing[full_name]["Phone Number"])
                print ("Email Address: ", contact_tracing[full_name]["Email Address"])
                print ()
                print (stylize (f"               VACCINATION DETAILS (as of {date}, {time_now})", colored.fg('orange_1')))
                print ()
                print ("Date of First Dose: ", contact_tracing[full_name]["First Vaccination Date"])
                print ("Brand of First Dose: ", contact_tracing[full_name]["Brand of First Vaccination"])
                print ("Date of Second Dose: ", contact_tracing[full_name]["Second Vaccination Date"])
                print ("Brand of Second Dose: ", contact_tracing[full_name]["Brand of Second Vaccination"])
                print ("Had taken booster shot: ", contact_tracing[full_name]["Booster Shot"])
                print ("Date of Booster Shot: ", contact_tracing[full_name]["Booster Shot Date"])
                print ("Brand of Booster Shot: ", contact_tracing[full_name]["Brand of Booster Shot"])
                print ()
                time.sleep (1)
